...
public class OnlineAppFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(rootView==null){
            rootView=inflater.inflate(R.layout.fragment_online_app2, container, false);
        }
...
//        mRecyclerView.setNestedScrollingEnabled(true);
        ...
        // when there is only 1 items to see in the recycler, this is triggered
        mRecyclerView.setupMoreListener(new OnMoreListener() {
            ...
            public void onMoreAsked(final int numberOfItems, int numberBeforeMore, int currentItemPos) {
                ...
                Log.e("OO","numberOfItems是"+numberOfItems+"numberBeforeMore是"+numberBeforeMore+"currentItemPos是"+currentItemPos);
//                mAdapter.notifyItemChanged(1);
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                      mAdapter.notifyItemChanged(numberOfItems);
