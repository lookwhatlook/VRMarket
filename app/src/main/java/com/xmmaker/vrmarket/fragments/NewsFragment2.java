...
import com.xmmaker.vrmarket.NetworkHelper;
...
//        View rootView = inflater.inflate(R.layout.fragment_news, container, false);
        ...
        dataList=new ArrayList<NewsListBean.T1348649580692Bean>();
        ...
        // when there is only 5 items to see in the recycler, this is triggered
    ...
    private void setClick() {
        mAdapter.setOnItemClickListener(new NewsListAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (dataList.size() != 0) {
                    String news_url = dataList.get(position).getUrl_3w();
